...
We then wanted to investigate whether the type of crust and tectonic setting influenced the number of eruptions. To clarify these variables; the earth’s crust is split into tectonic plates which lie on top of the mantle. 
...
-Intermediate
-And unknown plates. 
The tectonic setting is the movement of the plates and mantle that causes the volcano to form. The tectonic settings are given as the variables:
...
When reviewing the number of eruptions on each crust type it is clear that continental crust has more eruptions than oceanic or intermediate crust. Then looking at the number of eruptions for each tectonic setting the subduction zone has much more eruptions than rift zone or intraplate volcanoes. When referring back to the distribution maps this connection is shown as all of the subduction volcanos are on land, whilst most ocean volcanos appear to be rift volcanos, a scientific study of why this is the case would be really interesting if future research occurred.
