...
ggplot(crust_fit_aug, mapping=aes( x=.fitted, y =.resid)) +
	...
	labs(x="Predicted Frequency of Volcanic Eruptions", y="Residuals")
```
The residuals of predicted frequency seem to be in 3 distinct clusters, potentially that represent each of the 3 different crust types, however the plot further supports that a linear model is not appropriate for the data in question.
